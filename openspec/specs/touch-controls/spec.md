...
## Purpose
Defines the on-screen touch button overlay for mobile devices, covering visibility rules, held directional input, one-shot jump, and prevention of browser double-tap zoom.
## Requirements
