...
## Purpose
Defines how the camera tracks the player each frame, clamps to map boundaries to avoid showing out-of-bounds areas, and centres itself when a map dimension fits entirely within the canvas.
## Requirements
