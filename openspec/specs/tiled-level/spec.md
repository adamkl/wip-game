# tiled-level Specification

## Purpose
Defines how the game loads a Tiled map and tileset (bundled at build time), which tiles become solid physics objects, and what world-space dimensions are returned for use by the camera and spawn logic.
## Requirements
