# character-cycling Specification

## Purpose
Defines how the player cycles through the six available characters and how animated vs. static characters handle their run/idle animation states.
## Requirements
